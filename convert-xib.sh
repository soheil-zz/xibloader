...
RESOURCES_FOLDER=`dirname "$SRCROOT/AppTestStandalone/AppTestStandalone"`
...
echo "$TEMPLATE" | sed "s/ORIGINAL_FILENAME/$ORIGINAL_FILENAME/g;s/SANITISED_FILENAME/$SANITISED_FILENAME/g" >> $tmp.2
done
